        ...
        <div class="flex flex-col gap-3 w-full">
            ...
            <div class="flex text-xs justify-between font-light items-center">
                ...
                <div class="justify-end">
                    <svg id="delete-${todo.id}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor"  class="w-6 h-6 border bg-gray-100 rounded-full border-gray-600 p-0.5 opacity-50 hover:opacity-80 cursor-pointer focus:opacity-100 hover:animate-bounceTwice">
